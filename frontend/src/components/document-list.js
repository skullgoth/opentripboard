  ...
  return `
    <div class="document-item" data-document-id="${document.id}">
      ...
      <div class="document-info">
        ...
        <div class="document-meta">
          ...
          ${showUploader && document.uploadedByName ? `
            <span class="document-uploader">by ${escapeHtml(document.uploadedByName)}</span>
          ` : ''}
        </div>
      ...
      <div class="document-actions">
        <button type="button" class="btn btn-icon btn-sm" data-action="download-document" data-document-id="${document.id}" title="Download">
        ...
        ${canEdit ? `
          <button type="button" class="btn btn-icon btn-sm" data-action="edit-document" data-document-id="${document.id}" title="Edit">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
              <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
            </svg>
          </button>
          <button type="button" class="btn btn-icon btn-sm btn-danger" data-action="delete-document" data-document-id="${document.id}" title="Delete">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
